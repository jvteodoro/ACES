module readBusMux_tribuf
  #(
   ...
   always_comb begin
      case ( tribuf_status )
	PHASE_0:  bank0_mode = 2'd0;
	PHASE_1:  bank0_mode = 2'd1;
	PHASE_2:  bank0_mode = 2'd2;
	default:  bank0_mode = 2'd3;
   ...
   always_comb begin
      case ( tribuf_status )
	PHASE_0:  bank1_mode = 2'd1;
	PHASE_1:  bank1_mode = 2'd2;
	PHASE_2:  bank1_mode = 2'd0;
	default:  bank1_mode = 2'd3;
      endcase
   end
   ...
   always_comb begin
      case ( tribuf_status )
	PHASE_0:  bank2_mode = 2'd2;
	PHASE_1:  bank2_mode = 2'd0;
	PHASE_2:  bank2_mode = 2'd1;
	default:  bank2_mode = 2'd3;
      endcase
   end
