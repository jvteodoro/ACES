...
module tb_i2s_fft_tx_adapter;
    ...
    initial begin
        ...
        send_fft_bin(2'd0, 18'sd10, -18'sd10,  8'sd5, 1'b0);
        send_fft_bin(2'd1, 18'sd20, -18'sd20,  8'sd5, 1'b0);
        send_fft_bin(2'd2, 18'sd30, -18'sd30,  8'sd5, 1'b1);
        send_fft_bin(2'd0, 18'sd40, -18'sd40, -8'sd3, 1'b0);
        send_fft_bin(2'd1, 18'sd50, -18'sd50, -8'sd3, 1'b1);
