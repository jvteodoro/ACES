...
module tb_fft_window_multiplier;
    ...
    fft_window_multiplier #(.FRAME_LENGTH(1024), .COEFF_FILE("rtl/frontend/hann_window_q15_1024.hex")) dut (
    ...
    initial begin
        ...
        apply_and_check(0, 0);
        apply_and_check(512, 1000);
        apply_and_check(1023, 0);
